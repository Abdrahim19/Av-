...
<section  className="d-flex flex-column-reverse flex-lg-row align-items-center gap-3">
  <div className='heroimg_container col-xl-6'>
<img  src="/peinture_noire.png" alt="hero_img" className="hero_img" />
  </div>
<div className='col-xl-6 flex flex-col justify-content-center '>
